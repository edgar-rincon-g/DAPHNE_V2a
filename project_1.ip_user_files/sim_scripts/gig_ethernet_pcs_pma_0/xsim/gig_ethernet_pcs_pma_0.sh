...
elaborate()
{
  xelab --relax --debug typical --mt auto -L gig_ethernet_pcs_pma_v16_2_2 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gig_ethernet_pcs_pma_0 xil_defaultlib.gig_ethernet_pcs_pma_0 xil_defaultlib.glbl -log elaborate.log
}
...
map_local_libs()
{
  ...
  local_libs=(gig_ethernet_pcs_pma_v16_2_2)
